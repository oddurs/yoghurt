...
- [x] `0014` Render the interface into a buffer a test can read <sup>chore · p0 · testing</sup>
...
- [x] `0077` The closing message from agent done checks the wrong directory <sup>bug · p2 · cli</sup>
...
- [x] `0027` Read global npm, pnpm and yarn packages <sup>feature · p0 · source</sup>
- [x] `0028` Read go, gem, pipx and uv <sup>feature · p1 · source</sup>
- [x] `0029` Read application bundles and who signed them <sup>feature · p0 · source</sup>
- [x] `0030` Name the binaries nobody claims <sup>feature · p1 · source</sup>
...
- [x] `0035` Adding a source is one file <sup>docs · p2 · docs</sup>
- [x] `0036` Test every adapter against a fixture tree <sup>chore · p0 · testing</sup>
